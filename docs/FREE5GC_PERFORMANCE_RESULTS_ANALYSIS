...
![Processes making futex syscall on idle system (by latency)](./assets/free5gc/sysprocess_futex_fig_m2.medium.jpeg "Processes making futex syscall on system (by latency)")

<b>Fig.3.1 - Processes making futex syscall on system (by latency) - 20 secs</b>

![Processes making futex syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_futex_fig_m2.medium.jpeg "Processes making futex syscall on system (by number of calls)")
...
![Processes making epoll_wait syscall on idle system (by latency)](./assets/free5gc/sysprocess_epoll_wait_fig_m2.medium.jpeg "Processes making epoll_wait syscall on idle system (by latency)")

<b>Fig.3.1 - Processes making epoll_wait syscall on system (by latency) - 20 secs</b>

![Processes making epoll_wait syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_epoll_wait_fig_m2.medium.jpeg "Processes making epoll_wait syscall on system (by number of calls)")
...
![Processes making recvmsg syscall on idle system (by latency)](./assets/free5gc/sysprocess_recvmsg_fig_m2.medium.jpeg "Processes making recvmsg syscall on system (by latency)")

<b>Fig.3.1 - Processes making recvmsg syscall on system (by latency) - 20 secs</b>

![Processes making recvmsg syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_recvmsg_fig_m2.medium.jpeg "Processes making recvmsg syscall on system (by number of calls)")
...
![Processes making clock_nanosleep syscall on idle system (by latency)](./assets/free5gc/sysprocess_clock_nanosleep_fig_m2.medium.jpeg "Processes making clock_nanosleep syscall on system (by latency)")

<b>Fig.3.1 - Processes making clock_nanosleep syscall on system (by latency) - 20 secs</b>

![Processes making clock_nanosleep syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_clock_nanosleep_fig_m2.medium.jpeg "Processes making clock_nanosleep syscall on system (by number of calls)")
...
![Processes making poll syscall on idle system (by latency)](./assets/free5gc/sysprocess_poll_fig_m2.medium.jpeg "Processes making poll syscall on system (by latency)")

<b>Fig.3.1 - Processes making poll syscall on system (by latency) - 20 secs</b>

![Processes making poll syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_poll_fig_m2.medium.jpeg "Processes making poll syscall on system (by number of calls)")
...
![Processes making select syscall on idle system (by latency)](./assets/free5gc/sysprocess_select_fig_m2.medium.jpeg "Processes making select syscall on system (by latency)")

<b>Fig.3.1 - Processes making select syscall on system (by latency) - 20 secs</b>

![Processes making select syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_select_fig_m2.medium.jpeg "Processes making select syscall on system (by number of calls)")
...
![Processes making ppoll syscall on idle system (by latency)](./assets/free5gc/sysprocess_ppoll_fig_m2.medium.jpeg "Processes making ppoll syscall on system (by latency)")

<b>Fig.3.1 - Processes making ppoll syscall on system (by latency) - 20 secs</b>

![Processes making ppoll syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_ppoll_fig_m2.medium.jpeg "Processes making ppoll syscall on system (by number of calls)")
...
![Processes making read syscall on idle system (by latency)](./assets/free5gc/sysprocess_read_fig_m2.medium.jpeg "Processes making read syscall on system (by latency)")

<b>Fig.3.1 - Processes making read syscall on system (by latency) - 20 secs</b>

![Processes making read syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_read_fig_m2.medium.jpeg "Processes making read syscall on system (by number of calls)")
...
![Processes making openat syscall on idle system (by latency)](./assets/free5gc/sysprocess_openat_fig_m2.medium.jpeg "Processes making openat syscall on system (by latency)")

<b>Fig.3.1 - Processes making openat syscall on system (by latency) - 20 secs</b>

![Processes making openat syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_openat_fig_m2.medium.jpeg "Processes making openat syscall on system (by number of calls)")
...
![Processes making sendto syscall on idle system (by latency)](./assets/free5gc/sysprocess_sendto_fig_m2.medium.jpeg "Processes making sendto syscall on system (by latency)")

<b>Fig.3.1 - Processes making sendto syscall on system (by latency) - 20 secs</b>

![Processes making sendto syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_sendto_fig_m2.medium.jpeg "Processes making sendto syscall on system (by number of calls)")
...
![Processes making sched_yield syscall on idle system (by latency)](./assets/free5gc/sysprocess_sched_yield_fig_m2.medium.jpeg "Processes making sched_yield syscall on system (by latency)")

<b>Fig.3.1 - Processes making sched_yield syscall on system (by latency) - 20 secs</b>

![Processes making sched_yield syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_sched_yield_fig_m2.medium.jpeg "Processes making sched_yield syscall on system (by number of calls)")
...
![Processes making recvfrom syscall on idle system (by latency)](./assets/free5gc/sysprocess_recvfrom_fig_m2.medium.jpeg "Processes making recvfrom syscall on system (by latency)")

<b>Fig.3.1 - Processes making recvfrom syscall on system (by latency) - 20 secs</b>

![Processes making recvfrom syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_recvfrom_fig_m2.medium.jpeg "Processes making recvfrom syscall on system (by number of calls)")
...
<details><summary><b>Click to see results for processes making fdatasync system calls</b></summary>

![Processes making fdatasync syscall on idle system (by latency)](./assets/free5gc/sysprocess_fdatasync_fig_m2.medium.jpeg "Processes making fdatasync syscall on system (by latency)")

<b>Fig.3.1 - Processes making fdatasync syscall on system (by latency) - 20 secs</b>

![Processes making fdatasync syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_fdatasync_fig_m2.medium.jpeg "Processes making fdatasync syscall on system (by number of calls)")

<b>Fig.2 - Processes making fdatasync syscall on system (by number of calls) - 20 secss</b>
...
<details><summary><b>Click to see results for processes making write system calls</b></summary>

![Processes making write syscall on idle system (by latency)](./assets/free5gc/sysprocess_write_fig_m2.medium.jpeg "Processes making write syscall on system (by latency)")

<b>Fig.3.1 - Processes making write syscall on system (by latency) - 20 secs</b>

![Processes making write syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_write_fig_m2.medium.jpeg "Processes making write syscall on system (by number of calls)")

<b>Fig.2 - Processes making write syscall on system (by number of calls) - 20 secss</b>
...
![Processes making nanosleep syscall on idle system (by latency)](./assets/free5gc/sysprocess_nanosleep_fig_m2.medium.jpeg "Processes making nanosleep syscall on system (by latency)")

<b>Fig.3.1 - Processes making recvfrom syscall on system (by latency) - 20 secs</b>

![Processes making nanosleep syscall on system (by number of calls)](./assets/free5gc/sysprocess_count_nanosleep_fig_m2.medium.jpeg "Processes making nanosleep syscall on system (by number of calls)")

<b>Fig.2 - Processes making nanosleep syscall on system (by number of calls) - 20 secss</b>
